			...
			<div id="comments" class="comments-area post-reply">
				...
				<ol class="comment-list post-reply-list">
					...
					the_comments_pagination(
						array(
							'prev_text' => '<i class="fa fa-angle-left" aria-hidden="true"></i> <span class="screen-reader-text">' . __( 'Previous', 'atarikafa' ) . '</span>',
				...
				<div class="comment-reply-dashed-comment">
					...
					<span class="dashicons dashicons-lock locked-post comments-locked-alert"
						title="<?php _e( 'Locked Topic', 'siforum' ); ?>"></span>

...
function siforum_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting(
		'siforum_theme_options[text_test]',
		array(
			'default'    => 'value_xyz',
	...
	//  =============================
	$wp_customize->add_setting(
		'siforum_theme_options[color_scheme]',
		array(
			'default'    => 'value2',
			'capability' => 'edit_theme_options',
			'type'       => 'option',
	...
	//  =============================
	$wp_customize->add_setting(
		'siforum_theme_options[checkbox_test]',
		array(
			'capability' => 'edit_theme_options',
			'type'       => 'option',
		)
	...
	//  =============================
	$wp_customize->add_setting(
		'siforum_theme_options[header_select]',
		array(
			'default'    => 'value2',
			'capability' => 'edit_theme_options',
			'type'       => 'option',
	...
	//  =============================
	$wp_customize->add_setting(
		'siforum_theme_options[image_upload_test]',
		array(
			'default'    => 'image.jpg',
			'capability' => 'edit_theme_options',
			'type'       => 'option',
	...
	//  =============================
	$wp_customize->add_setting(
		'siforum_theme_options[upload_test]',
		array(
			'default'    => 'uploadtest',
			'capability' => 'edit_theme_options',
			'type'       => 'option',
	...
	//  =============================
	$wp_customize->add_setting(
		'siforum_theme_options[link_color]',
		array(
			'default'           => '#000',
	...
	//  =============================
	$wp_customize->add_setting(
		'siforum_theme_options[page_test]',
		array(
			'capability' => 'edit_theme_options',
			'type'       => 'option',
...
function misha_my_load_more_scripts() {
	...
	wp_register_script( 'my_loadmore', get_stylesheet_directory_uri() . '/assets/js/siforum.js?v1', array( 'jquery' ) , rand() , true );
